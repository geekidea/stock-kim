 ...
 */
@Repository
public interface UserStockBillMapper extends BaseMapper<UserStockBill> {
     ...
     * @return
     */
    IPage<UserStockBill> getUserStockBillPageList(@Param("page") Page page, @Param("query") UserStockBillQuery userStockBillQuery);
