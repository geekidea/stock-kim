...
package io.geekidea.framework.common.api;
...
public class ApiResult<T> implements Serializable {
    ...
    public static ApiResult resultMap(boolean flag,String key,Object value){
        Map<String,Object> map = new HashMap<>();
        map.put(key,value);
        if (flag){
            return ok(map);
    ...
    public static ApiResult failMap(String key,Object value){
        Map<String,Object> map = new HashMap<>();
        map.put(key,value);
        return fail(map);
    }
