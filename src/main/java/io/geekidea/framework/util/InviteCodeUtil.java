...
public class InviteCodeUtil {
    ...
    public static void main(String[] args) {
        System.out.println(generate(123L));;
        System.out.println(generate(123L));;
        System.out.println(generate(1L));;
        System.out.println(generate(2L));;
        System.out.println(generate(3L));;
        System.out.println(decode("SFZPKH"));
        System.out.println(decode("5HHHA4"));
    }
